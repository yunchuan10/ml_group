...
<template>
  <div style="overflow: hidden;">
    <div v-for="(li, index) in pictureList" :key="index" class="upload-main-div" style="width: 200px; height: 198px;">
      ...
      <input v-if="!disabled" class="upload-btn" title=' ' type="file" :accept="accept" :id="acceptId + index" @change="picupload($event, index)" style="width: 202px; height: 200px;">
      <div class="title" v-show="!li.url" style="width: 202px; height: 200px;">
        <div style="width: 202px; height: 200px; text-align:center;">
          <p>
