        ...
        <div class="h-tab-content">
          ...
          <table class="h-table-info" style="margin:10px 0;">
            <tr>
              ...
              <th v-if="reportAreaLevel && reportAreaLevel.indexOf('SECTION') > '-1'">县级正职</th>
              <th v-if="reportAreaLevel && reportAreaLevel.indexOf('SECTION') > '-1'">县级副职</th>
              <th v-if="reportAreaLevel && reportAreaLevel.indexOf('SECTION') > '-1'">正科级</th>
              <th v-if="reportAreaLevel && reportAreaLevel.indexOf('SECTION') > '-1'">副科级</th>
              <th v-if="reportAreaLevel && reportAreaLevel.indexOf('SECTION') > '-1'">科级以下</th>

              <th v-if="reportAreaLevel && reportAreaLevel.indexOf('ADMINISTRATIVE') > '-1'">乡级正职</th>
              <th v-if="reportAreaLevel && reportAreaLevel.indexOf('ADMINISTRATIVE') > '-1'">乡级副职</th>
              <th v-if="reportAreaLevel && reportAreaLevel.indexOf('ADMINISTRATIVE') > '-1'">乡级以下</th>
            </tr>
