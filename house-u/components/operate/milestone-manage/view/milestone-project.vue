    ...
    <section>
      ...
      <div class="h-table f-relative">
        <el-table :data="list" stripe style="width: 100%">
          ...
          <el-table-column prop="roomAddress" label="里程碑名称">
          </el-table-column>
          <el-table-column prop="roomAddress" label="内容">
          </el-table-column>
          <el-table-column prop="roomAddress" label="开始日期">
          </el-table-column>
          <el-table-column prop="roomAddress" label="结束日期">
          </el-table-column>

          <el-table-column fixed="right" prop="operation" label="操作">
            <template slot-scope="scope">
              <a @click="basicInfoClick('123')">详情</a>
              <router-link :to="{path: '/operate/milestone-manage/new-milestone', query:{id: '123'}}">修改</router-link>
...
<script>
import basicDetail from '@/components/operate/milestone-manage/milestone-details'; // 详情弹出框
export default {
  components: {
