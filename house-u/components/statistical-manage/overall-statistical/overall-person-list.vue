  ...
  <div>
    <section class="m-main">
      ...
      <div class="h-table f-relative">
        <h2 class="u-table-title">2018年-滁州市文明办人员信息表</h2>
        <el-table :data="list" stripe style="width: 100%">
          ...
          <el-table-column prop="personNum" label="职务级别" width="120">
          </el-table-column>
          <el-table-column prop="kongzhiNum" label="编制情况" width="120">
          </el-table-column>
          <el-table-column prop="kongzhiarea" label="房间号" width="120">
          </el-table-column>
          <el-table-column prop="officeNum" label="房间位置" width="120">
          </el-table-column>
          <el-table-column prop="officearea" label="标准面积（㎡）" width="120">
          </el-table-column>
