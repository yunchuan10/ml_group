  ...
  <div>
    <section class="m-main">
      ...
      <div class="h-table f-relative">
        <h2 class="u-table-title">2018年—安徽省滁州市各地区办公用房超标情况一览表</h2>
        <div class="f-pull-right">
          <el-radio-group v-model="activeName" style="margin-bottom: 30px;" size="small">
            <el-radio-button label="超标人数">超标人数</el-radio-button>
            <el-radio-button label="超标面积">超标面积</el-radio-button>
          </el-radio-group>
        </div>
        ...
        <el-table :data="list" stripe style="width: 100%">
          ...
          <el-table-column prop="area" label="地区">
            <template slot-scope="scope">
              <router-link to="/statistical-manage/exceed-statistical/exceed-company-list">{{scope.row.area}}</router-link>
            </template>
          </el-table-column>
          <el-table-column prop="personNum" label="超标单位数量">
          </el-table-column>
