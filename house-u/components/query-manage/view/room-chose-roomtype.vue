  ...
  <div>
    <el-dialog custom-class="m-detail-dialog m-car-detail" append-to-body :show-close="false" width="950px" :visible.sync="carDetailShow" @close="clearData">
      ...
      <div class="u-detail-dialog-content">
        ...
        <el-tree @check="getCheckNode" class="filter-tree" :data="roomTypes" node-key="value" show-checkbox default-expand-all :accordion="true" :filter-node-method="filterNode" ref="roomTypeTree">
        </el-tree>
