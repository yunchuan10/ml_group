  ...
  <div :id="promptId">
    <el-dialog class="YPromptDialog" append-to-body :visible.sync="show" :close-on-click-modal="false" :close-on-press-escape="false" :show-close="false" width="550px">
      ...
      <span slot="footer" class="dialog-footer">
        <el-button class="f-but-blue" @click="YPromptCloseClick">确定</el-button>
      </span>
    </el-dialog>
  </div>
</template>
...
.YPromptDialog {
  .el-dialog {
    ...
    .el-dialog__body {
      font-size: 0; padding: 40px 38px 10px 40px; border: 0;

      .f-message {
        display: table; width: 100%;

        .f-message-img {
          display: table-cell; width: 20px; padding-right: 10px; vertical-align: middle;
        }

        .f-message-text {
          font-size: 16px; display: table-cell; vertical-align: middle; color: #555;
        }
      }

      .f-message-auxiliary {
        font-size: 14px; margin-left: 30px; color: #555;margin-top: 12px;
      }
    }
