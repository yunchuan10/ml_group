  ...
  <div>
    <section class="m-main">
      ...
      <div class="m-breadcrumb">
        <zl-breadcrumb title="会议管理" :item="breadcrumbItem"></zl-breadcrumb>
      </div>
      ...
      <div class="h-tab-content" style="padding-bottom: 20px;">
        <el-form ref="ruleForm" :model="ruleForm" :rules="rules">
          <table class="h-table-info h-table-info-meet">
            <tr>
              ...
              <td width="40%">
                ...
                <span style="float: left;margin: 10px 10px 0; padding: 0 5px;color: #ddd">-</span>
                <el-form-item prop="applyRealName" style="float: left;">
          ...
          <div class="f-text-center" style="margin-top: 20px;">
            ...
            <el-button class="u-submit-btn submit-btn" :loading="loading" @click="submitClick">确定</el-button>
          </div>
        </el-form>
      </div>
    </section>
  ...
  methods: {
    ...
    getDataRequest() {
      ...
      this.$axiosGet(API.roomApply_toSaveApply, params).then(res => {
        // this.roomInfoVOList = res.model.roomInfoVOList || [];
        if (res.status === 200) {
    ...
    // 选中承办人
    selectUser(val) {
      val = val||this.ruleForm.applyRealName;
