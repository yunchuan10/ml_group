    ...
    <section class="m-main">
      ...
      <div class="h-table f-relative" style="margin-top:40px;">
        ...
        <el-table :data="topTotalList" stripe style="width: 100%">
          <el-table-column label="序号" width="55px" type="index"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    getOrganMeetingApplyCountByYear() {
      ...
      this.$axiosGet(
        API.statisticAnalysis_organMeetingApplyCountByYear,
        params
      ).then(res => {
    ...
    getAppointRoomTotleByYear() {
      ...
      this.$axiosGet(API.statisticAnalysis_appointRoomTotleByYear, params).then(
        res => {
          // console.log('res',JSON.stringify(res))
          if (res.status === 200) {
