  ...
  <div>
    <section class="m-main">
      ...
      <div class="m-breadcrumb">
        <Y-Breadcrumb title="房产证" :item="['权属管理','房产证']" type="1"></Y-Breadcrumb>
        <div class="u-bread-btn-group">
          <router-link to="/ownership-manage/house-certificate/update">
      ...
      <div class="h-table f-relative">
        <el-table :data="list" stripe style="width: 100%">
          ...
          <el-table-column label="房屋取得方式" prop="houseAcquisitionModeName"></el-table-column>
          ...
          <el-table-column label="操作">
            <template slot-scope="scope">
              ...
              <router-link :to="{path: '/ownership-manage/house-certificate/update', query: {housePropertyArchivesId:scope.row.id}}">修改</router-link>
...
<script>
import detail from '@/components/ownership-manage-v2/house-certificate/detail'
export default {
  components: {
    'V-Detail': detail
  },
  ...
  methods: {
    ...
    getDataRequest() {
      ...
      this.$axiosPost(API.housePropertyArchives_housePropertyArchivesList, params).then(res => {
        if (res.data) {
          let list = [];
          list = res.data.data || [];
    ...
    getEchartData() {
      ...
      this.$axiosPost(API.housePropertyArchives_housePropertyArchivesChartList, params).then(res => {
    ...
    deleteClick(id) { // 存储删除参数
      this.housePropertyArchivesId = id;
      this.YConfirmShow = true;
    },
    // 删除
    YDeleteClick() {
      let params = {
        id: this.housePropertyArchivesId
      }
      this.$axiosPost(API.housePropertyArchives_doDelete, params).then(res => {
