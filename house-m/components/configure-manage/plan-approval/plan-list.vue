    ...
    <section class="m-main">
      ...
      <div class="h-table f-relative">
        <el-table :data="list" stripe style="width: 100%">
          ...
          <el-table-column label="拟调整办公地址" prop="companyArea">
            <!-- <template slot-scope="scope">
              {{scope.row.builtArea}}
            </template> -->
          </el-table-column>
          <el-table-column label="方案制定人" prop="douser">
            <!-- <template slot-scope="scope">
              {{scope.row.builtArea}}
            </template> -->
          </el-table-column>
          ...
          <el-table-column fixed="right" label="操作">
            <template slot-scope="scope">
              <a @click="approvalInfoClick()" type="text">审批</a>
...
import planDetail from '@/components/configure-manage/plan-approval/plan-detail'; // 详情弹出框
export default {
  components: {
  ...
  methods: {
    ...
    // 详情
    planDetailClick() {
      this.$refs.planDetail.openModal();
    },
