<template>
  <div>
        ...
        <el-table :data="list" stripe style="width: 100%">
          ...
          <el-table-column fixed="right" prop="operation" label="操作">
            <template slot-scope="scope">
              ...
              <a @click="contractExpiredClick(scope.row.storeysId)">设置</a>
            </template>
    ...
    <!-- 合同到期提醒 -->
    <contract-expired ref="contractExpired" @requestData="getDataRequest"></contract-expired>
...
export default {
  ...
  methods: {
    ...
    contractExpiredClick() {
      this.$refs.contractExpired.openModal();
    },
    // 详情
