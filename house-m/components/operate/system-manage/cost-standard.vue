  ...
  <div>
    <section class="m-main">
      ...
      <div class="m-breadcrumb">
        <Y-Breadcrumb title="到期提醒"></Y-Breadcrumb>
      </div>
      <div class="h-table f-relative">
        <el-table :data="list" stripe style="width: 100%">
          ...
          <el-table-column prop="address" label="启用/停用时间">
            <template slot-scope="scope">
              {{scope.row.floorName || '—'}}
            </template>
          </el-table-column>
          <el-table-column fixed="right" prop="operation" label="操作">
            <template slot-scope="scope">
              ...
              <a @click="costRentClick(scope.row.storeysId)">设置</a>
            </template>
    ...
    <!-- 滞纳金弹框 -->
    <!-- <cost-latefee ref="costLatefee" @requestData="getDataRequest"></cost-latefee> -->
    <!-- 租金金弹框 -->
    <cost-rent ref="costRent" @requestData="getDataRequest"></cost-rent>
...
import costRent from '@/components/operate/system-manage/cost-setup/cost-rent'; // 租金弹出框
import costLatefee from '@/components/operate/system-manage/cost-setup/cost-latefee'; // 滞纳金弹出框
export default {
  components: {
    'building-detail': buildingDetail,
    'cost-rent': costRent,
    // 'cost-latefee': costLatefee,
  },
  data() {
    return {
      courtyardId: '', // 院落ID
  ...
  methods: {
    ...
    // costLatefeeClick() {
    //   this.$refs.costLatefee.openModal();
    // },

    //租金
    costRentClick() {
      this.$refs.costRent.openModal();
    },
    // 详情
