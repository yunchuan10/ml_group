            ...
            <el-timeline-item placement="top" v-for="(item,index) in contractList" :key="index">
              <el-card>
                ...
                <ul class="u-history-ul">
                  ...
                  <li>合同编号：
                    <a :title="item.contractNo" @click="roomDetailInfoClick(item.id)">{{item.contractNo | ellipsis}}</a>
                  </li>
