  ...
  <div>
    <el-dialog custom-class="m-detail-dialog m-car-detail" append-to-body :show-close="false" width="950px" :visible.sync="carDetailShow">
      ...
      <div class="u-detail-dialog-content">
        <ul class="house-nav-tab" style="margin-top:5px;">
        ...
        <div class="h-tab-content" v-show="pageSelect=='basic'">
          <table class="h-table-info">
            ...
            <tr>
              ...
              <td> <span v-show='rentalDetailList.proposedRentYear != ""'>{{rentalDetailList.proposedRentYear}}年</span></td>
              <th class="f-text-right">备注</th>
              <td>{{rentalDetailList.remark}}</td>
            </tr>
          </table>
          <table class="h-table-info f-cancel-margin-bottom">
            <tr>
          ...
          <el-table :data="list" stripe style="width: 100%">
            ...
            <el-table-column prop="dealArea" label="经营面积（㎡）" width='120px'>
            </el-table-column>
        ...
        <div class="h-tab-content" v-show="pageSelect=='recording'">
          <table class="h-table-info">
            <tr>
