      ...
      <div class="h-table f-relative">
        <el-table :data="list" stripe style="width: auto">
          ...
          <el-table-column prop="realName" label="申请单号">
            <template slot-scope="scope">
              <a @click="approvalDetailClick()">{{scope.row.realName}}</a>
            </template>
          </el-table-column>
          <el-table-column prop="dutiesLevelName" label="申请单位">
          </el-table-column>
          <el-table-column prop="duty" label="申请调配面积">
          </el-table-column>
          <el-table-column prop="isEstablished" label="审批状态">
          </el-table-column>
...
<script>
import approvalDetail from '@/components/super-search/company-search/view/approval-detail'; // 详情弹出框
export default {
  components: {
