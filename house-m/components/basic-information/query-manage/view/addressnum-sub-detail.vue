            ...
            <table class=" h-table-info">
              <tr>
                ...
                <td style="width: 200px;">
                  ...
                  <span class="z-state f-vertical-align-middle u-span-left" v-show="!houseStatus" :class="checkStatus(roomData.useStatus)">{{roomData.useStatusName}}</span></td>
...
export default {
  ...
  methods: {
    // 初始化弹出框
    openModal(id, type,chao,houseStatus) {
