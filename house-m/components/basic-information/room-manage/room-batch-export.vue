      ...
      <div class="m-content">
        <div class="u-file">
          <a href="javascript:;" class="f-but-blue">
            ...
            <input type="file" class="f-file" accept=".xls,.xlsx" @change="fileUpload" v-if="clearShow" />
          </a>
  ...
  methods: {
    ...
    saveClick() {
      if (this.formData !== null && this.formData !== '') {
        ...
        this.$axiosPost(API.room_import, params).then(res => {
    ...
    downloadTemplate() {
      window.open(`${API.room_downLoad}?flag=1&_token=${this.oldToken}`)
    },
    // 中断
    // interruptClick() {
