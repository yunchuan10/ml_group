    ...
    <section class="m-main">
      ...
      <div class="m-breadcrumb">
        ...
        <div class="u-bread-btn-group">
          <button class="f-pull-right u-bread-btn" @click="openCharacterDialog()">新增</button>
        </div>
      </div>
      <!--  tab切换 -->
      ...
      <div style="height: 450px;overflow:auto;">
        <el-form ref="ruleForm" :model="ruleForm" label-position="right" label-width="100px">
          <el-form-item
            label="角色名"
            prop="characterName"
            :rules="{required: true,message: '角色名不能为空', trigger: 'change'}"
          >
          ...
          <el-form-item label="角色菜单">
            <div style="border:1px solid #DCDFE6;padding: 20px;height:300px;overflow: auto;">
              <el-tree
                :default-expanded-keys="ruleForm.characterMenu"
                :data="menuList"
                node-key="value"
...
export default {
  ...
  methods: {
    ...
    getCheckedNodes() {
      //获取半选中和全选中状态key
      this.checkContent = this.$refs.characterMenu
        .getHalfCheckedNodes()
        .concat(this.$refs.characterMenu.getCheckedNodes(false, false));
    },
    //提交
    submitClick() {
