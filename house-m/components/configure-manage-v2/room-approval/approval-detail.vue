    ...
    <el-dialog custom-class="m-detail-dialog m-car-detail" append-to-body @close="pageSelect == 'basic'" :show-close="false" width="950px" :visible.sync="carDetailShow">
      ...
      <div class="u-detail-dialog-content" style="padding-bottom:20px;">
        ...
        <ul class="house-nav-tab">
          ...
          <li v-show="formkey === 'manageAfterMakePlan' || formkey ===null" @click="pageSelect = 'plan'" :class="{'active':pageSelect=='plan'}">
            <a>调配方案</a>
          </li>
        ...
        <div class="h-tab-content" v-show="pageSelect=='basic'">
          <table class="h-table-info">
            <tr>
              ...
              <td>{{organTypeName?organTypeName:''}}</td>
            </tr>
            <tr>
        ...
        <div class="h-tab-content" v-show="pageSelect=='plan'">
          ...
          <div v-for="(item,index) in roomBaseResponseList" :key="index">
            <h2 class="h-table-subtitle" style="margin: 10px 0;">
              ...
              <div class="u-bread-btn-group f-pull-right" style="margin-top: -5px;">
        ...
        <div class="h-tab-content" v-show="pageSelect=='history'">
          <el-timeline>
            <el-timeline-item v-for="(item, index) in commontHis" :key="index" :timestamp="returnDataFormat(item.createTime)" placement="top">
              <el-card>
...
export default {
  ...
  computed: {
    ...
    basicArea() {
      let num = 0;
      num = parseFloat(Number(this.officeCheckArea) + Number(this.serviceCheckArea) + Number(this.equipCheckArea)).toFixed(2)
      return num;
    },
    totalArea() {
      let num = 0;
