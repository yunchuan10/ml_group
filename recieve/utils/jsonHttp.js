...
// 推荐接口-post请求
const axiosPostJsonResponse = (url, param = null) => {
  if (param === null) param = {};
  return axios({
      method: 'post',
      url: url,
...
// 推荐接口-put请求
const axiosPutResponse = (url, param = null) => {
  if (param === null) param = {};
  return axios({
      method: 'put',
      url: url,
...
// 推荐接口-put请求JSON
const axiosPutJsonResponse = (url, param = null) => {
  if (param === null) param = {};
  return axios({
      method: 'put',
      url: url,
...
// 推荐接口-delete请求
const axiosDeleteResponse = (url, param = null) => {
  if (param === null) param = {};
  return axios({
      method: 'delete',
      url: url,
...
// 推荐接口-delete请求JSON
const axiosDeleteJsonResponse = (url, param = null) => {
  if (param === null) param = {};
  return axios({
      method: 'delete',
      url: url,
...
export default {
  install(Vue) {
    ...
    Vue.prototype.$axiosPut = axiosPutResponse; //put请求
    Vue.prototype.$axiosJsonPut = axiosPutJsonResponse; //put请求  
    Vue.prototype.$axiosDelete = axiosDeleteResponse; //Delete请求  
    Vue.prototype.$axiosJsonDelete = axiosDeleteJsonResponse; //Delete请求  
    Vue.prototype.$axiosJsonPost = axiosPostJsonResponse; // 推荐接口-post请求
    Vue.prototype.$axiosJsonPut = axiosPutJsonResponse; // 推荐接口-post请求
