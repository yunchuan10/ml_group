...
#m-full-map {
  .m-right {
    width: 100%;
    .all-map-font {
      position: absolute;color: red;cursor: pointer;font-size: 35px;font-weight: bold;right: 100px;text-align: right;text-shadow: 1px 2px 5px #888888;top: 6px;width: calc(100% - 100px);
    }
    #map-right {
      position: relative;
      .car-label-type {
        ...
        img {
          height: 10px;margin-right: 5px;width: 10px;
        }
        span {
          font-size: 14px;
        }
      ...
      .dialogVisible {
        position: absolute;background-color: #FFFFFF;border: 1px solid #AAAAAA;border-radius: 6px;cursor: move;height: 345px;top: 0;width: 400px;
        .u-title {
          background-color: #EEEEEE;border-radius: 6px;padding: 12px 15px;
          .f-right {
        ...
        .u-bottom {
          position: absolute;border-top: 1px solid #EEEEEE;bottom: 0;padding: 8px 15px;text-align: right;width: calc(100% - 30px);
        }
        .m-status {
          font-size: 14px;
          .f-text {
