  ...
  <div id="trip-update">
    <section class="m-main">
      ...
      <div class="m-breadcrumb">
        <Y-Breadcrumb title="接待任务办理" :item="['接待任务办理']"></Y-Breadcrumb>
      ...
      <div class="el-steps-item">
        <el-steps finish-status="success" :active="pageActive" align-center>
          <!-- <el-step title="用车办理"></el-step> -->
          <el-step title="会议办理"></el-step>
          <el-step title="住宿办理"></el-step>
          <el-step title="用餐办理"></el-step>
        </el-steps>
      </div>
            ...
            <div v-for="(item ,index) in meetingForm.addvehicle" :key="index">
              ...
              <table class="h-table-info">
                ...
                <tr>
                  ...
                  <th>安排会务人员</th>
                  <td colspan="6">
                    <el-form-item :prop="'addvehicle.'+index+'.servePeople'">
                      <el-input v-model="item.servePeople" placeholder="请输入会务人员"></el-input>
                    </el-form-item>
                  </td>
                </tr>
